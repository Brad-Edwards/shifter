...
## [3.104.0](https://github.com/Brad-Edwards/shifter/compare/v3.103.0...v3.104.0) (2026-09-12)
...
* add workspace lifecycle admin (create/list/rename/archive/transfer) ([12b8bee](https://github.com/Brad-Edwards/shifter/commit/12b8beee3b037784e85b8cc035289afe6df3784f))
* add workspace lifecycle admin (create/list/rename/archive/transfer) ([9a9a882](https://github.com/Brad-Edwards/shifter/commit/9a9a88240ab73f5a963a95c0608c6b308af08ac0))
* add workspace membership and roles admin surface ([1be2e4b](https://github.com/Brad-Edwards/shifter/commit/1be2e4b30fab1d5a47fd3dd399c3b528cae27e70))
* add workspace membership and roles admin surface ([0e1716e](https://github.com/Brad-Edwards/shifter/commit/0e1716e46cac12416bc665ae45f07e0cfffefab2))
...
* assemble the EKS provisioner Job environment from the cross-stack contract ([91127a6](https://github.com/Brad-Edwards/shifter/commit/91127a6efbdb5dfb60d0d5f348efa0efa9fb28b7))
...
* dispatch the AWS provisioner as Kubernetes Jobs with an AWS-aware admission policy ([b9a01da](https://github.com/Brad-Edwards/shifter/commit/b9a01da654bfb64e9e72fd1d8088bcf7168a2004))
* enable AWS EKS Kubernetes Job launcher in bootstrap and record ADR-044-R6 ([49c2022](https://github.com/Brad-Edwards/shifter/commit/49c2022732f27086badabbb0c74b8f31930e60b9))
* enable EKS platform add-ons and workload-security parity ([fac87e8](https://github.com/Brad-Edwards/shifter/commit/fac87e8a4453a590c15929aba7b52034f97320e6))
...
* **platform:** add organization profile & settings API and admin console surface ([#1939](https://github.com/Brad-Edwards/shifter/issues/1939)) ([b8c6c6f](https://github.com/Brad-Edwards/shifter/commit/b8c6c6fea82abbd39b2c96eaca7d99eccc175f5c))
* **platform:** add organization profile and settings admin surface ([e171514](https://github.com/Brad-Edwards/shifter/commit/e1715146a67d9162565102fd48de9b7ff310cfa7))
...
* source Guacamole SFTP root from per-image realized metadata ([321c50c](https://github.com/Brad-Edwards/shifter/commit/321c50cebdb02f40e362b40ce27e2b31856d6b89))
* source Guacamole SFTP root from per-image realized metadata ([981ec89](https://github.com/Brad-Edwards/shifter/commit/981ec89c545779c79a2ef7e11f3a617a8480daa1))
* **terraform:** EKS add-ons, cluster-autoscaler, NetworkPolicy enforcement, and shared provisioner IAM ([3092260](https://github.com/Brad-Edwards/shifter/commit/30922605b4eba7301707fd5080efeebaf302df7b))
* **terraform:** publish range topology to SSM for the EKS provisioner-env contract ([1a67dd5](https://github.com/Brad-Edwards/shifter/commit/1a67dd5530edce92c482cff1d119e7cc529e613c))
...
* bump brace-expansion to patched versions (GHSA-3jxr-9vmj-r5cp) ([8a34236](https://github.com/Brad-Edwards/shifter/commit/8a3423652dce95ada8fef9936435c262b1b0ecfe))
* bump brace-expansion to patched versions for GHSA-3jxr-9vmj-r5cp ([1891408](https://github.com/Brad-Edwards/shifter/commit/189140897993bb9d1c4fe6be710d4858d38287ce))
* bump cryptography to 50.0.0 (CVE-2026-69247) ([644804a](https://github.com/Brad-Edwards/shifter/commit/644804ad2bd9adffa8ef1eb9d91c61f02b8a33b0))
* bump cryptography to 50.0.0 (CVE-2026-69247) ([f5c0356](https://github.com/Brad-Edwards/shifter/commit/f5c035647920fea719d9f18f2a0282ebf15f9fc8))
* bump ip-address to 10.4.0 across MCP lockfiles (GHSA-mwp4-54f8-5fhr) ([0f3bce3](https://github.com/Brad-Edwards/shifter/commit/0f3bce3e89526d636c2f099cb3669561ed489b7c))
* bump ip-address to 10.4.0 across MCP lockfiles (GHSA-mwp4-54f8-5fhr) ([741ced3](https://github.com/Brad-Edwards/shifter/commit/741ced323f5609aaee8fd5b032eb818da51464b7))
...
* **cms:** authorize range access against realized engine instances ([fc4dffe](https://github.com/Brad-Edwards/shifter/commit/fc4dffe7ae8c8a60dcdabefa0f3f3668117f78e4))
* **cms:** authorize range access against realized engine instances ([d7a2236](https://github.com/Brad-Edwards/shifter/commit/d7a22360fc600136a2b913733c61ef1e3940b426))
...
* **ctf:** renumber lifecycle migration to 0048 and regenerate contract after dev merge ([5a5e33a](https://github.com/Brad-Edwards/shifter/commit/5a5e33ab992fc5f3f6a9f81f62ecff8fa75a3350))
...
* **engine:** guard the instance-ref lookup against null user and request ([5e6927f](https://github.com/Brad-Edwards/shifter/commit/5e6927f9439af101522dad2a29f91c037d192d87))
* **engine:** satisfy S1142 and cover the owned-instance seam directly ([b087d8d](https://github.com/Brad-Edwards/shifter/commit/b087d8df4961930f31d358ba855c6032cd7dc45c))
* **engine:** stop forging AWS_REGION on GCP provisioner Jobs ([805a6b8](https://github.com/Brad-Edwards/shifter/commit/805a6b84e482296a4451e73abfa66f1e085fdf50))
* **engine:** stop forging AWS_REGION on GCP provisioner Jobs ([5855e93](https://github.com/Brad-Edwards/shifter/commit/5855e9367ba9e0109fc7f9802488f95c75a149a3))
* **gcp-dev:** carry the CTF content bucket through deploy IaC ([f3c3fe0](https://github.com/Brad-Edwards/shifter/commit/f3c3fe02dbf5116b938e538a6e13afb961396d29))
* **gcp-dev:** carry the CTF content bucket through deploy IaC ([c14d674](https://github.com/Brad-Edwards/shifter/commit/c14d674a0da81d0b1f7f4aa3aeecd67cc3eee1b1))
...
* **gcp:** scope range-host GCS to a signed URL, drop project-wide read ([71a9f78](https://github.com/Brad-Edwards/shifter/commit/71a9f78cd5028812d904226c4fcf4c44486f4ad7))
* **gcp:** scope range-host GCS to a signed URL, drop project-wide read ([10e85cc](https://github.com/Brad-Edwards/shifter/commit/10e85ccf2786a12943363bcea4cc71184deb8d68))
