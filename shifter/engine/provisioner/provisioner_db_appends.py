...
def _insert_operation_result(
    ...
    * conflicting replay -> different identity -> a second row for the same
    ...
    """
    # A conflict target requires SELECT on its columns in PostgreSQL. Omit it
    # to retain the INSERT-only boundary; result_identity is the only supplied
    # unique key (the primary key is generated by the database).
