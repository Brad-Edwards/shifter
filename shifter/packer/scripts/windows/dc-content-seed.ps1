...
# var.dc_content_script) which creates the OUs/users/groups/SPNs/DCSync ACL/flags/
...
#
# a2_setup.ps1 defaults its DNS forwarder to the link-local AWS Route 53 Resolver
