...
def _build_container_security_context(client: Any) -> Any:
...
def _build_pod_security_context(client: Any) -> Any:
...
def _build_writable_volumes(client: Any) -> list[Any]:
    volumes = []
...
def _build_container_volume_mounts(client: Any) -> list[Any]:
    return [
