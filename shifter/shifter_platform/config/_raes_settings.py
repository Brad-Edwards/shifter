...
# Master feature flag for the RAES-native provisioning path (ADR-031). When
# False (the default), the RAES-native RuntimeTarget backend, dispatch, engine
# consumption, provisioner realization, and RAES catalog launchability are all
...
RAES_NATIVE_PROVISIONING_ENABLED = os.environ.get("SHIFTER_RAES_NATIVE_PROVISIONING", "False").lower() == "true"
