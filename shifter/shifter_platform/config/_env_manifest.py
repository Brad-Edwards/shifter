...
_EXPLICIT_BINDINGS = (
    ...
    EnvBinding(name="API_TOKEN_LAST_USED_COALESCE_SECONDS", default="300", source_file="config/settings.py"),
    EnvBinding(name="API_TOKEN_MAX_TTL_DAYS", default="365", source_file="config/settings.py"),
)
