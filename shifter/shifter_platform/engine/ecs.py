...
_GCP_PROVISIONER_ENV_KEYS = (
    ...
    # Polaris scenario content-baked images (selected by ami_key).
    "GDC_POLARIS_VM_IMAGE_URL",
    "GDC_POLARIS_VM_VCPUS",
    "GDC_POLARIS_VM_MEMORY",
    "GDC_POLARIS_VM_DISK_SIZE_GIB",
    "GDC_POLARIS_DC_IMAGE_URL",
    "GDC_POLARIS_DC_VCPUS",
    "GDC_POLARIS_DC_MEMORY",
    "GDC_POLARIS_DC_DISK_SIZE_GIB",
