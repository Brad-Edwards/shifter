...
urlpatterns = [
    ...
    path(
        "range/<uuid:request_id>/raes/operation-status/",
        views.RaesOperationStatusListView.as_view(),
        name="raes-operation-status",
    ),
    path(
        "range/<uuid:request_id>/raes/operation-receipts/",
        views.RaesOperationReceiptListView.as_view(),
        name="raes-operation-receipts",
    ),
    path(
        "range/<uuid:request_id>/raes/snapshots/",
        views.RaesRuntimeSnapshotListView.as_view(),
    ...
    path(
        "range/<uuid:request_id>/raes/participant-runtimes/",
        views.RaesParticipantRuntimeListView.as_view(),
        name="raes-participant-runtimes",
    ),
