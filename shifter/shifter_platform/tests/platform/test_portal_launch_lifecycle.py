...
def test_lifecycle_iam_is_present_and_scoped() -> None:
    ...
    # only scoped if the ASG arn is the Resource of its OWN statement. Checking
    # both substrings anywhere in the policy passes even when the action sits in
    # the neighbouring Describe statement, which carries Resource = "*".
