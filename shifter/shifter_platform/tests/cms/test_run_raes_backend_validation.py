...
from cms.raes.validation import RaesEvidenceSummary
from shared.enums import ResourceStatus

_CMD = "run_raes_backend_validation"
_MOD = "cms.management.commands.run_raes_backend_validation"
...
def test_happy_path_launches_validates_and_tears_down(smoke_env, monkeypatch):
    ...
    call_command(_CMD, "--scenario", "raes-x", "--poll-interval", "0")
...
def test_keep_flag_skips_teardown(smoke_env, monkeypatch):
    ...
    call_command(_CMD, "--scenario", "raes-x", "--poll-interval", "0", "--keep")
