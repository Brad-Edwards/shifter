# Portal composition outputs.
#
# Superset of what the environment roots publish; each root proxies only
# the outputs it published before this extraction, so no root gains or
# loses a public output (#688).
