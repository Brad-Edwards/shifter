...
MONITORED=(worker-cms worker-engine worker-mc worker-outbox-drainer worker-reconciler worker-provisioner-launcher ctf-scheduler guacamole-bootstrap-prune aces-operation-record-prune)
