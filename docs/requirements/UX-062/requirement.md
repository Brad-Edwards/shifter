...
Date, time, number, and currency formatting in user-facing surfaces shall honor the user's locale. The platform shall not assume US English conventions (e.g. MM/DD/YYYY dates, period decimal separators) when rendering values to users.
