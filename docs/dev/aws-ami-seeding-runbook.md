...
by building directly in prod. Private pack images are built and published from their owning repositories.
The base types above are the ones the portal plan requires.
